    ...
    <div className="DonationPage">
      <div className="donation-page">
        ...
        <div className="donation-grid">
         ...
         <Card
  title="תרומה בהעברה בנקאית"
  subTitle="ללא עמלות – ישירות לעמותה"
  className="donation-card bank-transfer-card"
  
>
  <p style={{ lineHeight: "1.8", direction: "rtl", textAlign: "right" }}>
